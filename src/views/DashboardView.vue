            ...
            <div class="card-body p-4 flex-1 flex flex-col overflow-hidden">
              ...
              <div class="flex-1 overflow-auto">
                ...
                <div v-else class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 2xl:grid-cols-7 gap-3">
                  <NodeCard v-for="node in nodeList" :key="node.id" :node="node" @detail="showNodeDetail" @edit="showNodeEdit" @delete="handleDeleteNode" />
                </div>
              </div>
            </div>
          </div>
                ...
                <table class="table table-xs table-pin-rows">
                  ...
                  <tbody>
                    ...
                    <tr v-else v-for="key in apiKeys" :key="key.id">
                      <ApiKeyRow :api-key="key" @detail="showApiKeyDetail" @edit="showApiKeyEdit" @delete="handleDeleteApiKey" />
                    </tr>
                  </tbody>
                </table>
              </div>
